...
def placeorder(request):
    if request.method == 'POST':
        ...
        cburl = 'http://35.171.163.239/paidorder' #This ip '54.86.10.239' address is from the one i got from AWS.
        ...
        try:
            ...
            #Email Sending to Admin Notification.
            # email = EmailMessage (
            #     'You contacted Us',#subject
            #     f'Dear Michael, a customer  {first_name} {last_name} with the number {phone} has made reservation. \n \n kindly follow up on his reservation, thank you.',#message
            #     settings.EMAIL_HOST_USER,
            #     ['abbeymichael123@gmail.com'] 
            # )
